...
class DAQ_Move_Arduino(DAQ_Move_base):
    ...
    """
    _controller_units = 'Degrés'  # TODO for your plugin: put the correct unit here
    is_multiaxes = True  # TODO for your plugin set to True if this plugin is controlled for a multiaxis controller
    axes_names = {'pin10':10, 'pin11':11, 'pin12':12, 'pin13':13}  # TODO for your plugin: complete the list
    ...
    def ini_attributes(self):
        ...
        #  autocompletion
        self.controller: telemetrix = True
        self.pin_number = 10
        self.angle = 0
        self.min_pulse = 544
        self.max_pulse = 2400
    ...
    def get_actuator_value(self):
        ...
        pos = DataActuator(data=0) # when writing your own plugin replace this line
    ...
    def ini_stage(self, controller=None):
        ...
        self.controller = self.ini_stage_init(old_controller=controller,
                                              new_controller=telemetrix.Telemetrix())
        self.pin_number = int(10)
        info = "Logging OK"

        self.controller.set_pin_mode_servo(self.pin_number)  # todo
    ...
    def move_abs(self, value: DataActuator):
        ...
        self.controller.servo_write (self.pin_number, int(value.value()))
    ...
    def move_rel(self, value: DataActuator):
        ...
        ## TODO for your custom plugin
        #raise NotImplemented  # when writing your own plugin remove this line
        self.controller.servo_write(self.pin_number, int(value.value()))  # when writing your own plugin replace this line
    ...
    def stop_motion(self):
      ...
      #self.emit_status(ThreadCommand('Update_Status', ["Don't stop motion"]))
