...
class DAQ_1DViewer_Spectrometer(DAQ_Viewer_base):
    ...
    params = comon_parameters+[
        {'title':'réseau', 'name':'grating','type': 'list', 'limits': [Spectrometer.gratings[0],Spectrometer.gratings[1]], 'value':Spectrometer.gratings[0]}
    ...
    def commit_settings(self, param: Parameter):
        ...
        if param.name() == "central wavelength":
